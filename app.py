...
st.title("📱 USER INSIGHTS DASHBOARD: UK BANK APPS")
st.markdown("")
...
def ask_llm_openai(question: str, context_bullets: str):
    ...
    system = (
        ...
        "If asked about anything outside these reviews, politely explain you’re limited to the provided context."
        "When discussing time, rely only on the bullets’ review_date and highlight gaps if coverage is thin."
